...
void W_Test(void)
{
    ...
    System_WriteInteriorFlash(addrShort1, (uint8_t *)&device_state_init.DoorPwd, sizeof(device_state_init.DoorPwd)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
    ...
    System_ReadInteriorFlash(addrShort1, (uint8_t *)&device_state_init.DoorPwd, sizeof(device_state_init.DoorPwd)); // 读取数据，函数内自动按半字读取
